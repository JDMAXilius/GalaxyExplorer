...
|---|---|---|---|
| `galaxy_view_scene` | `GalaxyContent` | `milky_way_prefab` (DrawStars ×3 layers), `galaxy_pois_prefab` (`destination_tags` → 9 `LabelButton` tags + `DestinationTags`; the legacy POI markers are still in the prefab but switch themselves off) | Milky Way |
