// p3_leave_play.cs - CS-140, step four. Stops play mode. It does NOT quit the editor.
//
...
internal class CommandScript : IRunCommand
{
    public void Execute(ExecutionResult result)
    {
        ...
        {
            result.Log("P3 stop: not in play mode, nothing to do.");
            return;
        }

        if (!UnityEditor.EditorApplication.ExecuteMenuItem("Cosmic/Verify/P3 Leave Play"))
        {
        ...
        result.Log("P3 stop: leaving play mode. The editor stays open.\n" +
