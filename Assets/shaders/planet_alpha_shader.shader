		...
		SubShader
		{
			...
			Pass
			{
				...
				min16float4 frag(v2f i) : SV_Target
				{
					...
					min16float4 finalColor = min16float4(specAmount.xxx + lerp(baseColor, fresnelSideColor, fresnel), (min16float)_TransitionAlpha*albedoSpec.a);
