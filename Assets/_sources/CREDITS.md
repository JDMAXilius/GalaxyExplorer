...
|---|---|---|
| `Assets/Textures/nebulae/domes/sky_crab.png` | Higgsfield, `gpt_image_2_5`, 1344 x 576. Job `11d4b6ec-0627-4ba9-9ca9-4df0f502a8f6`. Prompted as the Crab's own far reaches: rusty orange and deep red filaments in a tangled web, a blue-white synchrotron haze in one region, mostly black, stars throughout. | The sky the Crab's own volume stands in, so the object does not stop at the edge of its points. |
| `Assets/Textures/nebulae/domes/sky_teal.png`, `sky_amber.png`, `sky_starfield.png`, `sky_violet.png` | Higgsfield, `gpt_image_2_5`, 1344 x 576. Jobs `2ee6a454`, `0f46733e`, `bf95b2de`, `9b78beea`. | Four skies for the other six nebulae, chosen by what the object is: two planetary nebulae under the same teal, an eruption under warm dust, the two objects inside star clouds under a crowded field, Orion under violet dust. |
